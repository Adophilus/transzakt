...
<template>
  <div
    class="z-10 h-screen w-screen bg-black bg-opacity-50 fixed top-0 left-0 flex justify-center items-center"
    style="margin-top: 0"
    v-show="props.isOpen"
  >
      <div
      ...
      >
        ...
        >
          ...
          >
            ...
            <div class="mt-5 sm:flex sm:items-center sm:justify-end">
