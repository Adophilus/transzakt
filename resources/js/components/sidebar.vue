...
import ChartBarIcon from './icons/chart-bar.vue'
import CogIcon from './icons/cog.vue'
import CreditCartIcon from './icons/credit-card.vue'
  ...
  >
    <div class="flex flex-col items-center flex-1 space-y-6">
      ...
      <nav class="flex flex-col items-center space-y-6">
        <router-link
          to="/dashboard"
          activeClass="bg-white active"
          class="p-2 transition-colors duration-300 rounded-lg group hover:bg-white"
        >
          <ChartBarIcon
            class="w-6 h-6 group-hover:stroke-blue-700 group-[.active]:stroke-blue-700"
          />
        </router-link>
        ...
        <router-link
          to="/transactions"
          activeClass="bg-white active"
          class="p-3 transition-colors duration-300 rounded-lg group hover:bg-white"
        >
          <CreditCartIcon
            class="w-6 h-6 group-hover:stroke-blue-700 group-[.active]:stroke-blue-700"
          />
