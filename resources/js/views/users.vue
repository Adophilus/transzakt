                        ...
                        <thead class="bg-gray-50 dark:bg-gray-800">
                            <tr>
                                <th scope="col" class="py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    ...
                                    <a href="#" class="flex">
                                      <ArrowLongUp class="w-4 h-4 -mr-1 text-gray-400 dark:text-gray-600" />
                                      <ArrowLongDown class="w-4 h-4 -ml-1 text-gray-400 dark:text-gray-600" />
                                    </a>
                                    </button>
                                </th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                            <tr>
                                <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                    <div>
                                        <h2 class="font-medium text-gray-800 dark:text-white">First name</h2>
                                        <p class="text-sm font-normal text-gray-600 dark:text-gray-400">Last name</p>
                                    </div>
                                </td>

<td>
                                    <div>
                                        <h4 class="text-left text-gray-700 dark:text-gray-200">user@email.com</h4>
                                        </div>
                                        </td>
                                
                                <td class="px-12 py-4 text-sm font-medium whitespace-nowrap">
                                    <div>
                                    <code class="text-gray-700 dark:text-gray-200">0123456790</code>
                                        </div>
                                        </td>
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <div class="inline px-3 py-1 text-sm font-normal rounded-full text-emerald-500 gap-x-2 bg-emerald-100/60 dark:bg-gray-800 uppercase">Active</div>
                                </td>
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <div>
                                    <code class="text-gray-700 dark:text-gray-200">$100000</code>
                                    </div>
                                </td>

                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <button class="group px-1 py-1 text-gray-500 transition-colors duration-200 rounded-lg dark:text-gray-300 hover:bg-gray-100">
                                        <ElipsisVertical class="w-6 h-6 group-hover:stroke-blue-700" />
                                    </button>
                                </td>
                            </tr>
                        </tbody>
